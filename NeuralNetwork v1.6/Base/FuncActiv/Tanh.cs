...
namespace NeuralNetwork.Base.FuncActiv
{
    class Tanh : ILayer
    {
        ...
        public Tensor4 CalcOutp(Tensor4 inp)
        {
            ...
            for (int d = 0; d < output.elements.Length; d++)
                            output.elements[d] = (System.Math.Exp(2.0*inp.elements[d]) - 1.0) / (System.Math.Exp(2.0*inp.elements[d]) + 1.0);
            return output;
        }
